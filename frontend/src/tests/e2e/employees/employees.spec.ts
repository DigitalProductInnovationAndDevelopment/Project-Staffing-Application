...
test.describe('Employee Page Tests', () => {
  ...
  test('should edit an existing employee', async ({ page }) => {
    ...
    await page.getByRole('row', { name: 'New Employee new@employee.com' }).getByRole('button').click();
    await page.getByRole('combobox').click();
  ...
  test('should delete an existing employee', async ({ page }) => {
    await page.getByRole('row', { name: 'New Employee 1 new@employee.' }).getByRole('button').click();
