...
const BackendRoutes = {
  ...
  GET_PROJECT_ASSIGNMENT_BY_PROJECT_ID: (projectId, profileId) =>
    '/project/' + projectId + '/' + profileId + 'assign',
  UPDATE_PROJECT: (projectId) => '/project/' + projectId,
  UPDATE_PROJECT_ASSIGNMENT: (projectId, profileId) =>
    '/project/' + projectId + '/' + profileId + 'assign',
  DELETE_PROJECT: (projectId) => '/project/' + projectId,
  //project_api >> profile_api
  CREATE_NEW_PROFILE: (projectId) => '/project/' + projectId,
  GET_ALL_PROFILES_BY_PROJECT_ID: (projectId) =>
    '/project/' + projectId + '/profiles',
  GET_PROFILE_BY_ID: (projectId, profileId) =>
    '/project/' + projectId + '/' + profileId,
  UPDATE_PROFILE: (projectId, profileId) =>
    '/project/' + projectId + '/' + profileId,
